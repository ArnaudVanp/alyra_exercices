...
async function createMetaMaskDapp() {
    try {
      ...
      contratCredibilite.on('Remettre', (expediteur,expedSha) => {
        document.getElementById("expediteur").innerHTML = JSON.stringify(expediteur);
        document.getElementById("hash").innerHTML = JSON.stringify(expedSha);
        console.log("Voici l'adresse de celui qui vient de remettre son devoir :"+expediteur);
        console.log("Voici le hash du devoir : "+expedSha);
      });
